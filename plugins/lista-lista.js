...
{title: "📵 𝗖𝗛𝗔𝗧 𝗕𝗔𝗡𝗘𝗔𝗗𝗢𝗦 : 𝗕𝗔𝗡𝗡𝗘𝗗 𝗖𝗛𝗔𝗧𝗦", rowId: `${usedPrefix}chatsbaneados`, description: `𝑪𝒉𝒂𝒕𝒔 𝒅𝒐𝒏𝒅𝒆 𝒏𝒐 𝒑𝒖𝒆𝒅𝒆𝒏 𝒖𝒔𝒂𝒓 𝒂 ${wm}`},
{title: "🚷 𝗨𝗦𝗨𝗔𝗥𝗜𝗢𝗦 𝗕𝗔𝗡𝗘𝗔𝗗𝗢𝗦 : 𝗕𝗔𝗡𝗡𝗘𝗗 𝗨𝗦𝗘𝗥𝗦", rowId: `${usedPrefix}listbanuser`, description: `𝑼𝒔𝒖𝒂𝒓𝒊𝒐𝒔 𝒒𝒖𝒆 𝒏𝒐 𝒑𝒖𝒆𝒅𝒆𝒏 𝒖𝒔𝒂𝒓 𝒂 ${wm}`},
