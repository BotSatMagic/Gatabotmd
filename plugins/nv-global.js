...
if (!chat.isBanned && chat.audios && m.text.match(/(Buen día grupo|Buen dia grupo|🙌)/gi)) {    
let vn = './media/Buen día grupo.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (!chat.isBanned && chat.audios && m.text.match(/(Bueno si|bueno si|bueno sí|Bueno sí)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(El Toxico|El tóxico)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Elmo sabe donde vives|Elmo sabe dónde vives)/gi)) {    
let vn = './media/Elmo sabe donde vives.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (!chat.isBanned && chat.audios && m.text.match(/(En caso de una investigación|En caso de una investigacion)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Zzzz|zzz|😴)/gi)) {    
let vn = './media/Esta Zzzz.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (!chat.isBanned && chat.audios && m.text.match(/(Esto va ser épico papus|esto va ser épico papus|Esto va ser|Esto va a hacer|esto va acer|Esto va aser|esto va ser|esto va a hacer)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Fino señores|fino señores|Fino senores|fino senores|Fino)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Jesucristo|jesucristo|Jesús|jesús|Auronplay|Auron|Dios)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Me anda buscando anonymous|me anda buscando anonymous|Me está buscando anonymous|me está buscando anonymous|Me está buscando anonimo|Me esta buscando anonimo|anonimus|anónimo)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Motivacion|Motivación)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(nadie te pregunto|Nadie te pregunto|Nadie te preguntó|nadie te preguntó)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Parchís rata|parchís rata|Parchis es rata|parchís es rata|parchis es rata|parchis rata|rata parchis)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Cagaste|Miedo|miedo|Pvp|PVP|temor|que pasa|Que sucede|Que pasa|que sucede|Qué pasa|Qué sucede|Dime|dime)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(No Rompas más|No Rompas mas|💔)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Pokemon|pokemon|Pokémon|pokémon)/gi)) {    
let vn = './media/pokemon.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Porque ta tite|Por qué ta tite|Porque ta triste|Por qué ta titePor qué esta triste)/gi)) {    
let vn = './media/Porque ta tite.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
        
if (!chat.isBanned && chat.audios && m.text.match(/(Potaxio|Potasio|🥑)/gi)) {    
let vn = './media/Potaxio.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(sapo|Sapo|👀|Miron)/gi)) {    
let vn = './media/sapo.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Se están riendo de mí|Se estan riendo de mi|Se esta riendo de mi|Se está riendo de mi)/gi)) {    
let vn = './media/Se estan riendo de mi.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
         
if (!chat.isBanned && chat.audios && m.text.match(/(hablame|Habla me|Hablame|habla me|Háblame|háblame)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Te gusta el Pepino|🥒)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Verdad que te engañe|verdad que te engañe|verdad que|Verdad que)/gi)) {    
